...
* Emma: I created a scatter plot to show the relationship between gestational period, birth weight in ounces, and whether the mother smoked or not.  I used color = smoke to show the third variable of smoking so that I could see how the mother smoking affected the other two variables.  The data showed that gestation and birth weight were positively correlated and that mothers who still currently smoke tend to have earlier births. which can affect the newborn's birth weight and subsequently, their health. 